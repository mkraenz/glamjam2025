...
<main class="ingame" in:sceneIn out:sceneOut>
	...
	<p>
		Before I forget: You're customers will <span class="inline-emphasis">leave</span> if you make too
		many mistakes. I guess one or two mistakes are fine but no more than that.
	</p>
